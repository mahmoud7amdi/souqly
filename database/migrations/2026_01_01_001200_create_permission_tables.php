...
/**
 * spatie/laravel-permission tables, customised exactly like the original
 * project: `roles` carries `business_id` + `is_default`, and role names are
 * namespaced per tenant as `Admin#<business_id>` / `Cashier#<business_id>`.
 */
